...
class ZohoOAuthPersistenceByFile implements ZohoOAuthPersistenceInterface
{
    ...
    public function getOAuthTokens($userEmailId)
    {
        try {
            self::setIncludePath();
            // $serialized = file_get_contents( plugin_dir_url(__FILE__) . "zcrm_oauthtokens.txt", FILE_USE_INCLUDE_PATH );
            $serialized = file_get_contents( '/mnt/stor1-wc2-dfw1/424276/www.m2sys.com/web/content/test/' . "zcrm_oauthtokens.txt", FILE_USE_INCLUDE_PATH );
